<?php
session_start();
$hash = '83599b134aa4b74d8a2fa3799e7921ec';

if (!isset($_SESSION['auth'])) {
    if ($_SERVER['REQUEST_METHOD'] === 'POST' && md5($_POST['p']) === $hash) {
        $_SESSION['auth'] = true;
    } else {
        echo '<form method="POST"><input type="password" name="p" placeholder="Password"><button type="submit">Login</button></form>';
        exit;
    }
}
