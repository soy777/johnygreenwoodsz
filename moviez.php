...
<head>
    ...
    <style>
        ...
        body {
            background-image: url(https://www.hackread.com/wp-content/uploads/2016/03/artificially-intelligent-hackers-gif.gif);
...
<body>
    <div class="menu-header">
        <ul>
            ...
            <li><i class="fa-brands fa-github"></i>&nbsp;AVATAR</li>
            <li class="logo-gecko"><img width="290" height="290" src="https://res.cloudinary.com/dc1hapmew/image/upload/v1748946871/avatar_logo_mwezzq.png" align="right"></li>
